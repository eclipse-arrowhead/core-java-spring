...
\ArrowheadTitle{authorization-control-intra HTTP/TLS/JSON} %e.g. ServiceDiscovery HTTP/TLS/JSON
\ArrowheadServiceID{authorization-control-intra} % e.g. register
...
providerIdsWithInterfaceIds & \pref{List}$<$\hyperref[sec:model:ProviderInterfaceIds]{ProviderInterfaceIds}$>$ & yes & Array of provider and interface reference object.\\ \hline
...
\begin{table}[ht!]
\begin{tabularx}{\textwidth}{| p{6cm} | p{4cm} | X |} \hline
\rowcolor{gray!33} Field & Type & Description \\ \hline
authorizedProviderIdsWithInterfaceIds & \pref{List}$<$\hyperref[sec:model:ProviderInterfaceIds]{ProviderInterfaceIds}$>$ & Array of the authorized provider and interface re\-ference objects. \\ \hline
consumer & \hyperref[sec:model:SystemRecord]{SystemRecord}s & Descriptor of the consumer system. \\ \hline
