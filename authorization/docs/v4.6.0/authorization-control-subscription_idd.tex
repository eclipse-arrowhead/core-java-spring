...
\msubsection{struct}{CheckAuthSubscription}
\label{sec:model:CheckAuthSubscription}
...
publishers & \pref{List}$<$\hyperref[sec:model:SystemDescriptor]{SystemDescriptor}$>$ & yes & Descriptor of the publisher systems. (The output contains only the authorized publishers) \\ \hline
\end{tabularx}
\end{table}
