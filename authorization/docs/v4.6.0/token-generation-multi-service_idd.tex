...
\begin{lstlisting}[language=http,label={lst:authorization},caption={An \fref{token-generation-multi-service} invocation.}]
...
\begin{lstlisting}[language=http,label={lst:authorization},caption={An \fref{token-generation-multi-service} response.}]
{
  "data": [
    {
