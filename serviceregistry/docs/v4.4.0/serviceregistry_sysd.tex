...
\msubsection{produced}{echo}
\color{red}todo\color{black}

\msubsection{produced}{service-register}
\color{red}todo\color{black}

\msubsection{produced}{service-unregister}
\color{red}todo\color{black}

\msubsection{produced}{register-system}
\color{red}todo\color{black}

\msubsection{produced}{unregister-system}
\color{red}todo\color{black}

\msubsection{produced}{query}
\color{red}todo\color{black}

\msubsection{produced}{query-multi}
\color{red}todo\color{black}

\msubsection{produced}{query-all}
\color{red}todo\color{black}

\msubsection{produced}{query-by-system}
\color{red}todo\color{black}

\msubsection{produced}{query-by-system-id}
\color{red}todo\color{black}

\msubsection{produced}{pull-system}
\color{red}todo\color{black}
