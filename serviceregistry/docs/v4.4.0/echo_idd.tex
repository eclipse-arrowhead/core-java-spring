...
\begin{table}[ht!]
  ...
  \end{tabular}
  \caption{Communication and sematics details used for the \textbf{echo}
    service interface}
...
The rest of this document describes how to realize the echo service HTTP/TLS/TEXT interface in details.
...
Simple text nessage with the value of "Got it!".
