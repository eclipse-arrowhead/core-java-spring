...
\section{Overview}
\label{sec:overview}
This document describes the \textbf{pull-systems} service, which enables the systems to get system details for each system registered in Service Registry. Examples of this interaction is a dedicated core system that needs these informations.
...
Each subsection names an interface, an input type and an output type, in that order.
...
\pdef{Direction}        & String representing the sorting direction. \\ \hline
