...
which is enables autonomous service registration. It's implemented using protocol, encoding as stated in below table:
...
The rest of this document describes how to realize the service-register service
interface in detail.
