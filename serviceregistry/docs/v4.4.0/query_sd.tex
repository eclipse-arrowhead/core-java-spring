...
The given system is required to being aware how to consume the \textbf{query} service from Service Registry Core System in order to look for the other public core services such as orchestration from the Orchestrator Core System.  
