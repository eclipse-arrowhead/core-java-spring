...
This section describes the interfaces to the service. The \textbf{query-all} service is used to get every service instance data. A service could contain various metadata as well as a physical endpoint. The various parameters are representing the necessary system and service input information.
