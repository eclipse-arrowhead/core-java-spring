...
\ArrowheadTitle{register-system HTTP/TLS/JSON} %e.g. ServiceDiscovery HTTP/TLS/JSON
\ArrowheadServiceID{register-system} % e.g. register
...
\begin{table}[ht!]
  ...
  \end{tabular}
  \caption{Communication and sematics details used for the \textbf{register-system}
    service interface}
...
This structure is used to register a system into the Service Registry.

\begin{table}[ht!]
\begin{tabularx}{\textwidth}{| p{3cm} | p{3cm} | p{2cm} | X |} \hline
\rowcolor{gray!33} Field & Type & Mandatory & Description \\ \hline
address & \pref{Address} & yes & A string representation of the network address. \\ \hline
...
\msubsubsection{struct}{SystemResponse}
