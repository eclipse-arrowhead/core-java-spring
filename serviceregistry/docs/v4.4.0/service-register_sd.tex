...
The given service provider application system is required to use the  \textbf{service-register} service at its startup in order the offered services are being discoverable for the possible consumer application systems within the local cloud.   
...
This section describes the interfaces to the service. The \textbf{service-register} service is used to register services. A service could contain various metadata as well as a physical endpoint. The various parameters are representing the necessary service input information.
...
\begin{table}[ht!]
  ...
  \begin{tabular}{|l|l|l|l|}
    ...
    Ontology & N/A & - \\ \hline
  \end{tabular}
  \caption{Communication and sematics details.}
...
Here, all data objects that can be part of the \textbf{ServiceRegister} service
...
providerSystem                    & \pref{Object} & Descriptor of the provider system. \\ \hline
secure &\pref{SecureType}  & Type of security the service uses. \\ \hline
serviceDefinition &\pref{Name}        & Identifier of the service. \\ \hline
...
interfaces & \pref{Array}$<$\pref{Interface}$>$     & List of interfaces the service supports. \\ \hline
metadata & \pref{Metadata}     & Metadata \\ \hline
providerSystem & \pref{Object} & Descriptor of the provider system record. \\ \hline
secure &\pref{SecureType}  & Type of security the service uses. \\ \hline
