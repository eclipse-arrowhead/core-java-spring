...
\section{Overview}
\label{sec:overview}
This document describes the \textbf{query-by-system} service, which enables the systems to query for specific system details based on system parameters. Example of this interaction is a dedicated core system that needs the available information for a specific system.
...
Available only for the following core systems: \textit{ Orchestrator, Workflow Choreographer}
