...
\begin{table}[ht!]
  ...
  \end{tabular}
  \caption{Communication and semantics details used for the \textbf{query-by-system-id}
    service interface}
...
The rest of this document describes how to realize the \textbf{query-by-system-id} service HTTP/TLS/JSON interface in details.
