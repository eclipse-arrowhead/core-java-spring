...
\section{Overview}
\label{sec:overview}
This document describes the \textbf{query-by-system-id} service, which enables the systems to query for specific system details based on its record id. Example of this interaction is a dedicated core system that needs the available information for a specific system.
