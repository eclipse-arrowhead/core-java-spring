...
\begin{lstlisting}[language=http,label={lst:echo},caption={An \fref{echo} invocation.}]
GET /serviceregistry/echo HTTP/1.1
\end{lstlisting}

\begin{lstlisting}[language=http,label={lst:echo_response},caption={An \fref{echo} response.}]
Got it!
\end{lstlisting}
