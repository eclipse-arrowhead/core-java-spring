...
\ArrowheadTitle{query-by-system HTTP/TLS/JSON} %e.g. ServiceDiscovery HTTP/TLS/JSON
\ArrowheadServiceID{query-by-system} % e.g. register
...
\begin{table}[ht!]
  ...
  \end{tabular}
  \caption{Communication and semantics details used for the \textbf{query-by-system}
    service interface}
...
The rest of this document describes how to realize the \textbf{query-by-system} service HTTP/TLS/JSON interface in details.
