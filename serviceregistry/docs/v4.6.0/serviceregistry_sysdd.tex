...
\begin{table*}[ht!]
  ...
  \begin{tabular}{|r|r|r|r|}
    \hline
    \rowcolor{gray!33}\textbf{Services produced} & \textbf{Scope} & \textbf{Published} & \textbf{SD ref} \\
    \hline
 
    echo & Application + Core Systems & no & \color{red}todo\color{black} \\ \hline
    service-register & Application + Core Systems & yes & \href{https://github.com/arrowhead-f/core-java-spring/blob/sr-documentation/serviceregistry/docs/v4.4.0/service-register_sd.pdf}{link}\\ \hline
    service-unregister & Application + Core Systems & yes & \color{red}todo\color{black}\\ \hline
    register-system & Application + Core Systems & yes & \color{red}todo\color{black}\\ \hline
    unregister-system & Application + Core Systems & yes & \color{red}todo\color{black}\\ \hline
    query & Application + Core Systems & no & \color{red}todo\color{black}\\ \hline
    query-multi & Core Systems & no & \color{red}todo\color{black}\\ \hline
    query-all & Core Systems & no & \color{red}todo\color{black}\\ \hline
    query-by-system & Core Systems & no & \color{red}todo\color{black}\\ \hline
    query-by-system-id & Core Systems & no & \color{red}todo\color{black}\\ \hline
    pull-system & Core Systems & yes & \color{red}todo\color{black}\\ \hline
  \end{tabular}
\end{table*}
