...
\begin{table}[ht!]
  ...
  \end{tabular}
  \caption{Communication and semantics details used for the \textbf{service-register}
    service interface}
...
The rest of this document describes how to realize the \textbf{service-register} service HTTP/TLS/JSON interface in details.
...
\begin{lstlisting}[language=http,label={lst:register},caption={An fref{service-register} invocation.}]
