...
\section{Overview}
\label{sec:overview}
This document describes the \textbf{query-all} service, which enables dedicated core systems to get data about all service registry instance by one request, therefore it is an integral part of the implementation of service discovery requirements in Service Registry Mandatory Core System. Example of this interaction is a core system that needs the available information about every service instance from Service Registry.
