...
public class AccessTypesCollectionRequestExecutorTests {
	...
	private AccessTypesCollectionRequestExecutor testingObject;
	...
	public void setUp() {		
		...
		testingObject = new AccessTypesCollectionRequestExecutor(queue, relayClient, createGatekeeperRelayPerCloudMap());
