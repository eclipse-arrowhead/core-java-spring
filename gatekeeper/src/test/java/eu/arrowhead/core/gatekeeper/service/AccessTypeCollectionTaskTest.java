...
public class AccessTypeCollectionTaskTest {
	
	//=================================================================================================
	// members
	
	private AccessTypeCollectionTask testingObject;
	...
	public void setUp() {
		...
		testingObject = new AccessTypeCollectionTask(relayClient, getTestSession(), "test-name", "test-operator", "test-cn", "test-key", queue);
	}
	...
	public void testRunWithThrowingInvalidParameterExceptionByRelayClient1() throws JMSException, InterruptedException {
		...
		final ErrorMessageDTO cloudAccessResponseDTO = (ErrorMessageDTO) queue.take();
		assertTrue(cloudAccessResponseDTO.getExceptionType() == ExceptionType.INVALID_PARAMETER);
	}
	...
	public void testRunWithThrowingBadPayloadExceptionByRelayClient1() throws JMSException, InterruptedException {
		...
		final ErrorMessageDTO cloudAccessResponseDTO = (ErrorMessageDTO) queue.take();
		assertTrue(cloudAccessResponseDTO.getExceptionType() == ExceptionType.BAD_PAYLOAD);
	}
