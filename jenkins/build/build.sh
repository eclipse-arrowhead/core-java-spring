...
# Copy the SR jar and config to the build location
...
# Copy the Auth jar and config to the build location
...
# Copy the ORCH jar and config to the build location
...
# Copy the Gatekeeper jar and config to the build location
...
# Copy the Gateway jar and config to the build location
...
# Copy the Event Handler jar and config to the build location
