...
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud` TO 'system_registry'@'localhost';
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud_gatekeeper_relay` TO 'system_registry'@'localhost';
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud_gateway_relay` TO 'system_registry'@'localhost';
GRANT ALL PRIVILEGES ON `arrowhead`.`relay` TO 'system_registry'@'localhost';
...
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud` TO 'system_registry'@'%';
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud_gatekeeper_relay` TO 'system_registry'@'%';
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud_gateway_relay` TO 'system_registry'@'%';
GRANT ALL PRIVILEGES ON `arrowhead`.`relay` TO 'system_registry'@'%';
