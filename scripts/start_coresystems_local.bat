...
REM START "" /B "cmd /c javaw -jar arrowhead-eventhandler-4.4.0.jar > sout_eventhandler.log 2>&1"
REM echo Event Handler started

REM cd ..\..\datamanager\target
REM START "" /B "cmd /c javaw -jar arrowhead-datamanager-4.4.0.jar > sout_datamanager.log 2>&1"
