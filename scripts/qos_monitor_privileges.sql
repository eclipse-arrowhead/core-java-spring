...
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud_gateway_relay` TO 'qos_monitor'@'localhost';
GRANT ALL PRIVILEGES ON `arrowhead`.`relay` TO 'qos_monitor'@'localhost';
...
GRANT ALL PRIVILEGES ON `arrowhead`.`cloud_gateway_relay` TO 'qos_monitor'@'%';
GRANT ALL PRIVILEGES ON `arrowhead`.`relay` TO 'qos_monitor'@'%';
