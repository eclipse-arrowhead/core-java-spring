...
GRANT ALL PRIVILEGES ON `arrowhead`.`mscv_verification_execution` TO 'mscv'@'localhost';
GRANT ALL PRIVILEGES ON `arrowhead`.`mscv_verification_detail` TO 'mscv'@'localhost';
...
GRANT ALL PRIVILEGES ON `arrowhead`.`mscv_verification_execution` TO 'mscv'@'%';
GRANT ALL PRIVILEGES ON `arrowhead`.`mscv_verification_detail` TO 'mscv'@'%';
