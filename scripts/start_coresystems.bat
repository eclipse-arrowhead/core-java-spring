...
START "serviceregistry" /B "cmd /c javaw -jar arrowhead-serviceregistry-4.4.0.jar > sout_sr.log 2>&1"
echo Service Registry started
timeout /t %time_to_sleep% /nobreak > NUL

cd ..\..\authorization\target
START "" /B "cmd /c javaw -jar arrowhead-authorization-4.4.0.jar > sout_auth.log 2>&1"
echo Authorization started

cd ..\..\gateway\target
START "" /B "cmd /c javaw -jar arrowhead-gateway-4.4.0.jar > sout_gateway.log 2>&1"
echo Gateway started

cd ..\..\eventhandler\target
START "" /B "cmd /c javaw -jar arrowhead-eventhandler-4.4.0.jar > sout_eventhandler.log 2>&1"
echo Event Handler started

cd ..\..\datamanager\target
START "" /B "cmd /c javaw -jar arrowhead-datamanager-4.4.0.jar > sout_datamanager.log 2>&1"
echo DataManager started

cd ..\..\gatekeeper\target
START "" /B "cmd /c javaw -jar arrowhead-gatekeeper-4.4.0.jar > sout_gk.log 2>&1"
echo Gatekeeper started

cd ..\..\orchestrator\target
START "" /B "cmd /c javaw -jar arrowhead-orchestrator-4.4.0.jar > sout_orch.log 2>&1"
