...
import eu.arrowhead.core.gams.service.GamsService;
...
public class GamsController {
    ...
    private final GamsService onboardingDBService;
    ...
    @Autowired
    public GamsController(final GamsService onboardingDBService, final SSLProperties sslProperties) {
