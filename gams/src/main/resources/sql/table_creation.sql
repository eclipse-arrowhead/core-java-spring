...
(
    ...
    `source`      varchar(64),
    `data`        varchar(64),
    CONSTRAINT `fk_event_instance` FOREIGN KEY (`instance_id`) REFERENCES `gams_instance` (`id`) ON DELETE CASCADE,
...
(
    ...
    `quantity`    bigint(8),
    CONSTRAINT `fk_aggregation_instance` FOREIGN KEY (`instance_id`) REFERENCES `gams_instance` (`id`) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT `fk_action_plan_id` FOREIGN KEY (`action_plan_id`) REFERENCES `gams_composite_action` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_action_id` FOREIGN KEY (`action_id`) REFERENCES `gams_action` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
