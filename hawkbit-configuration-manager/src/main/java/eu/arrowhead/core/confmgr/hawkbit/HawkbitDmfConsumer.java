...
import eu.arrowhead.core.confmgr.hawkbit.model.EventType;
import eu.arrowhead.core.confmgr.hawkbit.model.MessageHeader;
...
import eu.arrowhead.core.confmgr.service.WebSocketService;
...
public class HawkbitDmfConsumer extends DefaultConsumer {
    ...
    /**
     * Start consuming from the HawkBit Configuration Manager queue on the hawkBit DMF API.
     *
     * @throws IOException if there is a connection problem with hawkBit
     */
