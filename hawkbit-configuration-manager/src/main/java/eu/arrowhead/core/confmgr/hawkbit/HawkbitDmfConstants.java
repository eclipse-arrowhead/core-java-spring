...
public class HawkbitDmfConstants {
    ...
    /**
     * The exchange name for all messages sent from hawkBit to the HawkBit Configuration Manager. It can be modified.
     */
    public static final String RECEIVING_EXCHANGE = "configuration_system.direct.exchange";

    /**
     * The queue name for all messages sent from hawkBit to the HawkBit Configuration Manager. It can be modified.
     */
    public static final String RECEIVING_QUEUE = "configuration_system_direct_queue";

    /**
     * The routing key for all messages sent from hawkBit to the HawkBit Configuration Manager. It can be modified.
     */
