...
package eu.arrowhead.core.confmgr.arrowhead.model.request;
 ...
 * necessary for the registration of the HawkBit Configuration Manager wrapper in the Service Registry.
 */
@AllArgsConstructor
@NoArgsConstructor
@Data
