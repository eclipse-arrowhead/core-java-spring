...
import eu.arrowhead.core.confmgr.security.JwtAuthenticationFilter;
import eu.arrowhead.core.confmgr.service.ArrowheadService;
import eu.arrowhead.core.confmgr.websocket.WebSocketController;
...
public class WebSocketSecurityConfig extends WebSecurityConfigurerAdapter implements WebSocketConfigurer {
    ...
    /**
     * Configuration of the HTTP security for the whole HawkBit Configuration Manager, including web socket connections.
