...
The Gatekeeper Core System should consume the Service Registry Core System's \textbf{query} service to get information about the \textbf{orchestration-qos-temporary-lock} service. Using this information the system can request the \textbf{orchestration-qos-temporary-lock} service with a lock request which contains information about the original requester and its orchestration results.
