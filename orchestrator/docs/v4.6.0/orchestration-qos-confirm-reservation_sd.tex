...
This section describes the interfaces to the service. The \textbf{orchestration-qos-confirm-reservation} service is used to keep and extend one of the provider locks while releasing all the other. The various parameters are representing the necessary system and service input information.
