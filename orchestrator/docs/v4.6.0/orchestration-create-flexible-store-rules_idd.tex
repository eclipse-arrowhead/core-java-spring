...
\ArrowheadTitle{orchestration-create-flexible-store-rules HTTP/TLS/JSON} %e.g. ServiceDiscovery HTTP/TLS/JSON
\ArrowheadServiceID{orchestration-create-flexible-store-rules} % e.g. register
