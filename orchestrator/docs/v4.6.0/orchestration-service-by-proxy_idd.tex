...
\begin{table}[ht!]
  ...
  \end{tabular}
  \caption{Communication and sematics details used for the \textbf{orchestration-service-by-proxy}
    service interface}
...
The rest of this document describes how to realize the \textit{orchestration-service-by-proxy} service HTTP/TLS/JSON interface in details.
