...
This document describes the \textbf{orchestration-qos-enabled} service interface, which which tells the requester whether the provider supports Quality-of-Service requirements or not. It's implemented using protocol, encoding as stated in the following table:
...
The rest of this document describes how to realize the orchestration-qos-enabled service HTTP/TLS/TEXT interface in details.
