...
\msubsection{service}{orchestration-by-proxy}
...
\msubsection{service}{orchestration-by-id}
...
\msubsection{service}{create-flexible-rule}
...
\msubsection{service}{remove-flexible-rule}
...
\msubsection{service}{clean-flexible-rules}
...
\msubsection{service}{qos-enabled}
...
\msubsection{service}{qos-reservations}
...
\msubsection{service}{qos-temporary-lock}
...
\msubsection{service}{confirm-reservation}
