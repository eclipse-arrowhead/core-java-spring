...
@Service
public class MsvcDBService {

    //=================================================================================================
    // members
    private final Logger logger = LogManager.getLogger(MsvcDBService.class);
    private final OrchestrationDriver orchestrationDriver;
    private final CertificateAuthorityDriver caDriver;
    private final SecurityUtilities securityUtilities;

    @Autowired
    public MsvcDBService(final OrchestrationDriver orchestrationDriver,
