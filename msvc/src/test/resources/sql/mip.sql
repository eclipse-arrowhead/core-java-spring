...
INSERT INTO `msvc_standard` (`id`, `identification`, `name`, `description`, `reference_uri`)
VALUES (1, 'BLA-4671-347', 'name', 'description', 'uri');

INSERT INTO `msvc_mip` (`id`, `ext_id`, `name`, `description`, `category_id`, `standard_id`, `domain_id`)
