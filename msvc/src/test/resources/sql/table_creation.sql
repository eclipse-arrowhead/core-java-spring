...
CREATE TABLE IF NOT EXISTS `msvc_script`
(
    `id`     bigint(20) PRIMARY KEY AUTO_INCREMENT,
    ...
    `mip_id` bigint       NOT NULL,
    CONSTRAINT `fk_script_mip` FOREIGN KEY (`mip_id`) REFERENCES `msvc_mip` (`id`) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT `fk_details_mip_entry` FOREIGN KEY (`verification_entry_id`) REFERENCES `msvc_mip_verification_entry` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_details_execution` FOREIGN KEY (`execution_id`) REFERENCES `msvc_verification_execution` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_details_script` FOREIGN KEY (`script_id`) REFERENCES `msvc_script` (`id`) ON DELETE CASCADE,
