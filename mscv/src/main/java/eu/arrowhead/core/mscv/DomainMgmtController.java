...
public class DomainMgmtController {
    ...
    private static final String CREATE_DOMAIN_URI = "/domain";
    ...
    private static final String READ_DOMAIN_URI = "/domain" + PARAMETER_NAME_PATH;
    ...
    private static final String READ_ALL_DOMAIN_URI = "/domain";
    ...
    private static final String UPDATE_DOMAIN_URI = "/domain" + PARAMETER_NAME_PATH;
    ...
    private static final String DELETE_DOMAIN_URI = "/domain" + PARAMETER_NAME_PATH;
    ...
    @ResponseBody
    public DomainDto delete(@PathVariable(PARAMETER_NAME) final String name) {
