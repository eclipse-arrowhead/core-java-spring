...
public class CoreDefaults {
	...
	public static final int DEFAULT_QOS_DEFAULT_REFERENCE_MEAN_RESPONSE_TIME_WITH_TIMEOUT = 32;
	public static final int DEFAULT_QOS_DEFAULT_REFERENCE_MEAN_RESPONSE_TIME_WITHOUT_TIMEOUT = 32;
	public static final int DEFAULT_QOS_DEFAULT_REFERENCE_JITTER_WITH_TIMEOUT = 2;
	public static final int DEFAULT_QOS_DEFAULT_REFERENCE_JITTER_WITHOUT_TIMEOUT = 2;
	public static final int DEFAULT_QOS_DEFAULT_REFERENCE_LOST_PET_MEASUREMENT_PERCENT = 0;
