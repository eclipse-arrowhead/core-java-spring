...
public class ICNProposalRequestDTO implements Serializable {
    ...
    public List<SystemRequestDTO> getPreferredSystems() {
        return preferredSystems;
    }

    public List<RelayRequestDTO> getPreferredGatewayRelays() {
        return preferredGatewayRelays;
    }

    public List<RelayRequestDTO> getKnownGatewayRelays() {
        return knownGatewayRelays;
    }

    public OrchestrationFlags getNegotiationFlags() {
    ...
    public boolean getGatewayIsPresent() {
        return gatewayIsPresent;
    }

    public String getConsumerGatewayPublicKey() {
        return consumerGatewayPublicKey;
    }
    ...
    public void setRequesterSystem(final SystemRequestDTO requesterSystem) {
        this.requesterSystem = requesterSystem;
    }
    ...
    public void setConsumerGatewayPublicKey(final String consumerGatewayPublicKey) {
