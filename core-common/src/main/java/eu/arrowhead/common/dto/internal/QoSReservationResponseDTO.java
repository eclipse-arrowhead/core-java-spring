...
public class QoSReservationResponseDTO implements Serializable {
    ...
    public long getReservedProviderId() {
        return reservedProviderId;
    }

    public long getReservedServiceId() {
        return reservedServiceId;
    }
    ...
    public void setReservedProviderId(final long reservedProviderId) {
        this.reservedProviderId = reservedProviderId;
    }

    public void setReservedServiceId(final long reservedServiceId) {
        this.reservedServiceId = reservedServiceId;
    }

    public void setConsumerSystemName(final String consumerSystemName) {
        this.consumerSystemName = consumerSystemName;
    }
    ...
    public void setConsumerPort(final int consumerPort) {
        this.consumerPort = consumerPort;
    }

    public void setReservedTo(final String reservedTo) {
        this.reservedTo = reservedTo;
    }

    public void setTemporaryLock(final boolean temporaryLock) {
        this.temporaryLock = temporaryLock;
    }
