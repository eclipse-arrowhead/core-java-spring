...
public class CloudWithRelaysAndPublicRelaysResponseDTO extends CloudResponseDTO {
    ...
    //-------------------------------------------------------------------------------------------------
    public List<RelayResponseDTO> getGatekeeperRelays() {
        return gatekeeperRelays;
    }

    public List<RelayResponseDTO> getGatewayRelays() {
        return gatewayRelays;
    }

    public List<RelayResponseDTO> getPublicRelays() {
        return publicRelays;
    }

    //-------------------------------------------------------------------------------------------------
    public void setGatekeeperRelays(final List<RelayResponseDTO> gatekeeperRelays) {
        this.gatekeeperRelays = gatekeeperRelays;
    }

    public void setGatewayRelays(final List<RelayResponseDTO> gatewayRelays) {
        this.gatewayRelays = gatewayRelays;
    }

    public void setPublicRelays(final List<RelayResponseDTO> publicRelays) {
        this.publicRelays = publicRelays;
    }
