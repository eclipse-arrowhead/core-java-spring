...
public class ChoreographerOFRRequestDTO implements Serializable {
    ...
    private static final long serialVersionUID = 4810743581987988255L;
    ...
    //-------------------------------------------------------------------------------------------------
    public ChoreographerOFRRequestDTO() {}
    ...
    //-------------------------------------------------------------------------------------------------
    public ChoreographerOFRRequestDTO validateCrossParameterConstraints() {
        ...
        if (orchestrationFlags.get(OrchestrationFlags.Flag.ENABLE_QOS) && commands.containsKey(QOS_COMMAND_EXCLUSIVITY) && !orchestrationFlags.get(OrchestrationFlags.Flag.MATCHMAKING)) {
    ...
    //-------------------------------------------------------------------------------------------------
    private ChoreographerOFRRequestDTO(final ChoreographerOFRRequestDTO.Builder builder) {
    ...
    public static class Builder {
        ...
        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder requestedService(final ServiceQueryFormDTO requestedService) {
            this.requestedService = requestedService;
            return this;
        }

        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder flag(final OrchestrationFlags.Flag flag, final boolean value) {
            this.orchestrationFlags.put(flag, value);
            return this;
        }

        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder flags(final OrchestrationFlags flags) {
            this.orchestrationFlags.putAll(flags);
            return this;
        }

        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder preferredProviders(final PreferredProviderDataDTO... preferredProviders) {
            this.preferredProviders = preferredProviders == null || preferredProviders.length == 0 ? List.of() : Arrays.asList(preferredProviders);
            return this;
        }

        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder commands(final Map<String,String> commands) {
            this.commands = commands;
            return this;
        }

        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder command(final String key, final String value) {
        ...
        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder qosRequirements(final Map<String,String> qosRequirements) {
            this.qosRequirements = qosRequirements;
            return this;
        }

        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO.Builder qosRequirement(final String key, final String value) {
            Assert.isTrue(key != null && !key.isBlank(), "Key is null or blank");
        ...
        //-------------------------------------------------------------------------------------------------
        public ChoreographerOFRRequestDTO build() {
            return new ChoreographerOFRRequestDTO(this).validateCrossParameterConstraints();
        }
    }
}
