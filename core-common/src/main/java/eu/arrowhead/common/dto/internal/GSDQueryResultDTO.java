...
public class GSDQueryResultDTO implements Serializable {
    ...
    //-------------------------------------------------------------------------------------------------
    public List<GSDPollResponseDTO> getResults() {
        return results;
    }
    ...
    //-------------------------------------------------------------------------------------------------
    public void setResults(final List<GSDPollResponseDTO> results) {
        this.results = results;
    }

    public void setUnsuccessfulRequests(final int unsuccessfulRequests) {
        this.unsuccessfulRequests = unsuccessfulRequests;
    }
