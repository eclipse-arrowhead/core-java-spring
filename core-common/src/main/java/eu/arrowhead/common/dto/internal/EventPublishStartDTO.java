...
public class EventPublishStartDTO implements Serializable {
    ...
    //-------------------------------------------------------------------------------------------------
    public EventPublishRequestDTO getRequest() {
        return request;
    }

    public Set<Subscription> getInvolvedSubscriptions() {
        return involvedSubscriptions;
    }

    //-------------------------------------------------------------------------------------------------
    public void setRequest(final EventPublishRequestDTO request) {
        this.request = request;
    }

    public void setInvolvedSubscriptions(final Set<Subscription> involvedSubscriptions) {
        this.involvedSubscriptions = involvedSubscriptions;
    }
