...
public class QoSRelayTestProposalRequestDTO implements Serializable {
    ...
    public String getSenderQoSMonitorPublicKey() {
        return senderQoSMonitorPublicKey;
    }
    ...
    public void setSenderQoSMonitorPublicKey(final String senderQoSMonitorPublicKey) {
