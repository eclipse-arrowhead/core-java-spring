...
public class RelayResponseListDTO implements Serializable {
	...
	//-------------------------------------------------------------------------------------------------
	public RelayResponseListDTO() {}

	//-------------------------------------------------------------------------------------------------
	public RelayResponseListDTO(final List<RelayResponseDTO> data, final long count) {
		this.data = data;
		this.count = count;
	}
