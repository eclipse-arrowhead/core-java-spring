...
public class QoSTemporaryLockRequestDTO implements Serializable {
    ...
    //-------------------------------------------------------------------------------------------------
    public SystemRequestDTO getRequester() {
        return requester;
    }

    public List<OrchestrationResultDTO> getOrList() {
        return orList;
    }

    //-------------------------------------------------------------------------------------------------
    public void setRequester(final SystemRequestDTO requester) {
        this.requester = requester;
    }

    public void setOrList(final List<OrchestrationResultDTO> orList) {
        this.orList = orList;
    }
