...
public class GeneralAdvertisementMessageDTO implements Serializable {
    ...
    //-------------------------------------------------------------------------------------------------
    public void setSenderCN(final String senderCN) {
        this.senderCN = senderCN;
    }

    public void setSenderPublicKey(final String senderPublicKey) {
        this.senderPublicKey = senderPublicKey;
    }

    public void setRecipientCN(final String recipientCN) {
        this.recipientCN = recipientCN;
    }
