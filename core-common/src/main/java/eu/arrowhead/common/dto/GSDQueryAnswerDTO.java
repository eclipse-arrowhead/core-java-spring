...
public class GSDQueryAnswerDTO implements Serializable {
	
	//=================================================================================================
	// members

	private static final long serialVersionUID = 3465669055047464858L;
	...
	//-------------------------------------------------------------------------------------------------	
	public GSDQueryAnswerDTO() {}
	
	public GSDQueryAnswerDTO(final CloudWithRelaysResponseDTO providerCloud, final String requiredServiceDefinition,
