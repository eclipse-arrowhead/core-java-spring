...
public class GSDPollResponseDTO implements Serializable, ErrorWrapperDTO {
    ...
    public String getRequiredServiceDefinition() {
        return requiredServiceDefinition;
    }
    ...
    public Integer getNumOfProviders() {
        return numOfProviders;
    }

    public List<QoSMeasurementAttributesFormDTO> getQosMeasurements() {
        return qosMeasurements;
    }
    ...
    public boolean isGatewayIsMandatory() {
        return gatewayIsMandatory;
    }

    public Set<RelayResponseDTO> getVerifiedRelays() {
        return verifiedRelays;
    }

    //-------------------------------------------------------------------------------------------------
    public void setProviderCloud(final CloudResponseDTO providerCloud) {
        this.providerCloud = providerCloud;
    }

    public void setRequiredServiceDefinition(final String requiredServiceDefinition) {
        this.requiredServiceDefinition = requiredServiceDefinition;
    }

    public void setAvailableInterfaces(final List<String> availableInterfaces) {
        this.availableInterfaces = availableInterfaces;
    }

    public void setNumOfProviders(final Integer numOfProviders) {
        this.numOfProviders = numOfProviders;
    }

    public void setQosMeasurements(final List<QoSMeasurementAttributesFormDTO> qosMeasurements) {
        this.qosMeasurements = qosMeasurements;
    }
    ...
    public void setGatewayIsMandatory(final boolean gatewayIsMandatory) {
        this.gatewayIsMandatory = gatewayIsMandatory;
    }

    public void setVerifiedRelays(final HashSet<RelayResponseDTO> verifiedRelays) {
        this.verifiedRelays = verifiedRelays;
    }
