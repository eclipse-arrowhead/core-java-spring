...
public class OrchestratorStoreRequestDTO implements Serializable {
    ...
    //-------------------------------------------------------------------------------------------------
    public void setServiceDefinitionName(final String serviceDefinitionName) {
        this.serviceDefinitionName = serviceDefinitionName;
    }

    public void setConsumerSystemId(final Long consumerSystemId) {
        this.consumerSystemId = consumerSystemId;
    }

    public void setProviderSystem(final SystemRequestDTO providerSystemDTO) {
        this.providerSystem = providerSystemDTO;
    }

    public void setCloud(final CloudRequestDTO cloudDTO) {
        this.cloud = cloudDTO;
    }

    public void setServiceInterfaceName(final String serviceInterfaceName) {
        this.serviceInterfaceName = serviceInterfaceName;
    }
    ...
    public void setAttribute(final Map<String, String> attribute) {
        this.attribute = attribute;
    }
