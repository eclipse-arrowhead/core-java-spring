...
public enum CoreSystemService {
	...
	QOS_MONITOR_INTER_DIRECT_PING_MEASUREMENT_SERVICE(CommonConstants.CORE_SERVICE_QOS_MONITOR_INTER_DIRECT_PING_MEASUREMENT, CommonConstants.QOS_MONITOR_URI + CommonConstants.OP_QOS_MONITOR_INTER_DIRECT_PING_MEASUREMENT + 
		 	   								  		  CommonConstants.OP_QOS_MONITOR_INTER_DIRECT_PING_MEASUREMENT_SUFFIX),
	QOS_MONITOR_INTER_RELAY_ECHO_MEASUREMENT_SERVICE(CommonConstants.CORE_SERVICE_QOS_MONITOR_INTER_RELAY_ECHO_MEASUREMENT, CommonConstants.QOS_MONITOR_URI + CommonConstants.OP_QOS_MONITOR_INTER_RELAY_MEASUREMENT),
