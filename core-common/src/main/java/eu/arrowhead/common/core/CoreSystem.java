...
public enum CoreSystem {
	...
	SERVICE_REGISTRY(Defaults.DEFAULT_SERVICE_REGISTRY_PORT, List.of(CoreSystemService.SERVICE_REGISTRY_REGISTER_SERVICE, CoreSystemService.SERVICE_REGISTRY_UNREGISTER_SERVICE)),
    SYSTEM_REGISTRY(Defaults.DEFAULT_SYSTEM_REGISTRY_PORT, List.of(CoreSystemService.SYSTEM_REGISTRY_REGISTER_SERVICE, CoreSystemService.SYSTEM_REGISTRY_UNREGISTER_SERVICE,
    															   CoreSystemService.SYSTEM_REGISTRY_ONBOARDING_WITH_NAME_SERVICE, CoreSystemService.SYSTEM_REGISTRY_ONBOARDING_WITH_CSR_SERVICE)),
    DEVICE_REGISTRY(Defaults.DEFAULT_DEVICE_REGISTRY_PORT, List.of(CoreSystemService.DEVICE_REGISTRY_REGISTER_SERVICE, CoreSystemService.DEVICE_REGISTRY_UNREGISTER_SERVICE,
    															   CoreSystemService.DEVICE_REGISTRY_ONBOARDING_WITH_NAME_SERVICE, CoreSystemService.DEVICE_REGISTRY_ONBOARDING_WITH_CSR_SERVICE)),
